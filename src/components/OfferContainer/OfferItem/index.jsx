    ...
    <OfferItemContainer>
      <OfferItemDetails>
        <OfferItemTextInfo>
          ...
          <OfferItemPrices>
            <OfferItemFullPrice>de R$ {product.price.toLocaleString('pt-BR')}</OfferItemFullPrice>
            <OfferItemDiscountedPrice>por R$ {product.price.toLocaleString('pt-BR')}</OfferItemDiscountedPrice>
          </OfferItemPrices>
        </OfferItemTextInfo>
        <Countdown />
        <ButtonContainer>
